...
func (_m *Storage) Create(ctx context.Context, link linkentity.Link) (uuid.UUID, error) {
	ret := _m.Called(ctx, link)

	var r0 uuid.UUID
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, linkentity.Link) (uuid.UUID, error)); ok {
		return rf(ctx, link)
	}
	if rf, ok := ret.Get(0).(func(context.Context, linkentity.Link) uuid.UUID); ok {
		r0 = rf(ctx, link)
	} else {
		if ret.Get(0) != nil {
...
func (_c *Storage_Create_Call) Return(_a0 uuid.UUID, _a1 error) *Storage_Create_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Storage_Create_Call) RunAndReturn(run func(context.Context, linkentity.Link) (uuid.UUID, error)) *Storage_Create_Call {
	_c.Call.Return(run)
	return _c
}
